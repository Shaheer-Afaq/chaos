...
public class PlayerSystem {
    ...
    public static void start(){ weaponTask = TaskScheduler.schedule(PlayerSystem::giveWeapon, 3*20, -1, true, null);}
...
//            getData(player).messages.set(0, "Weapon: ".concat(randomWeapon.getCustomName().getString()));
    ...
    public static void addWeapons(){
        ...
        Weapons.add(new ItemBuilder(Items.DIAMOND_AXE)
                .name("Fast Axe", Formatting.GOLD)
//                        .component(DataComponentTypes.)
                .build()
        );
    ...
    public static void addMisc(){
        Misc.add(new ItemBuilder(Items.HORSE_SPAWN_EGG)
                ...
                .entityData(EntityType.HORSE, nbt -> {
                    nbt.putByte("Tame", (byte) 1);
